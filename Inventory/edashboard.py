...
class EMS:
    def __init__(self,root,eid):
       ...
       self.root.title("Logged as Employee")
       ...
       btn_sales=Button(LeftMenu,text="Attendance",command=lambda:self.Attendance(eid),font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
    ...
    def Salary(self):
        ...
        self.new_obj=salary(self.new_win)

    def Task(self):
        self.new_win=Toplevel(self.root)
        self.new_obj=task(self.new_win)
