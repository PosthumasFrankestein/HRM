...
class esalaryClass:
    ...
    def __init__(self, root, eid):
        ...
        # row 2
        ttk.Label(self.root, text="Date", style="mystyle1.TLabel").place(x=50, y=190)
        ttk.Label(self.root, text="Salary", style="mystyle1.TLabel").place(x=350, y=190)
        ttk.Label(self.root, text="User Type", style="mystyle1.TLabel").place(
            x=750, y=190
        )
        ...
        # row 4
        ttk.Label(self.root, text="Rating", style="mystyle1.TLabel").place(x=50, y=270)
        ttk.Label(self.root, text="Bonus", style="mystyle1.TLabel").place(x=350, y=270)
        ttk.Label(self.root, text="Total Salary", style="mystyle1.TLabel").place(
            x=750, y=270
        )
