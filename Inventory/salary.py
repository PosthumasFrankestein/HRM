...
#row 3
      ...
      #button
       btn_receipt=Button(self.root,text="Print Receipt",command=self.approve,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=850,y=305,width=210,height=28)
       ...
       self.EmployeeTable=ttk.Treeview(emp_frame,columns=("eid","name","salary","absent_days","present_days","fsalary"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
